...
// This function determines the radius of the earthquke marker based on its magnitude
...
d3.json(earthquakeData).then(function(data) {
    ...
    pointToLayer: function(feature, latlng) {
        ...
        // Then add all teh details for the legend
        legend.onAdd = function() {
            ...
            // Looping through our intervals to generate a label wtih a colored square for each interval
